...
$GEM5_DIR/build/ALPHA/gem5.fast \
	...
	--vdd1=450 \
	--bit_faultrate1=2000 \
	--l1_access_energy_vdd3=TMP0.0266 \
	--l1_access_energy_vdd2=TMP0.0218 \
	--l1_access_energy_vdd1=TMP0.0207 \
	--l2_access_energy_vdd3=TMP0.1679 \
	--l2_access_energy_vdd2=TMP0.1498 \
	--l2_access_energy_vdd1=TMP0.1458 \
