...
STAT_FIELDS=" $STAT_FIELDS system.cpu.dcache.overall_avg_access_time::total"
...
STAT_FIELDS=" $STAT_FIELDS system.cpu.dcache.voltage_VDD1"
STAT_FIELDS=" $STAT_FIELDS system.cpu.dcache.voltage_VDD2"
STAT_FIELDS=" $STAT_FIELDS system.cpu.dcache.voltage_VDD3"
STAT_FIELDS=" $STAT_FIELDS system.cpu.dcache.static_power_VDD1"
STAT_FIELDS=" $STAT_FIELDS system.cpu.dcache.static_power_VDD2"
STAT_FIELDS=" $STAT_FIELDS system.cpu.dcache.static_power_VDD3"
STAT_FIELDS=" $STAT_FIELDS system.cpu.dcache.energy_per_access_VDD1"
STAT_FIELDS=" $STAT_FIELDS system.cpu.dcache.energy_per_access_VDD2"
STAT_FIELDS=" $STAT_FIELDS system.cpu.dcache.energy_per_access_VDD3"
...
STAT_FIELDS=" $STAT_FIELDS system.l2.overall_avg_access_time::total"
...
STAT_FIELDS=" $STAT_FIELDS system.l2.voltage_VDD1"
STAT_FIELDS=" $STAT_FIELDS system.l2.voltage_VDD2"
STAT_FIELDS=" $STAT_FIELDS system.l2.voltage_VDD3"
STAT_FIELDS=" $STAT_FIELDS system.l2.static_power_VDD1"
STAT_FIELDS=" $STAT_FIELDS system.l2.static_power_VDD2"
STAT_FIELDS=" $STAT_FIELDS system.l2.static_power_VDD3"
STAT_FIELDS=" $STAT_FIELDS system.l2.energy_per_access_VDD1"
STAT_FIELDS=" $STAT_FIELDS system.l2.energy_per_access_VDD2"
STAT_FIELDS=" $STAT_FIELDS system.l2.energy_per_access_VDD3"
